...
**Software Engineer** and **Systems Architect** focused on high-performance backends (**Java**, **PHP**, **C**, **Python**) and robust data engineering (**SQL**). Specialized in **Clean Architecture** and **S.O.L.I.D** principles.
**Engenheiro de Software** e **Arquiteto de Sistemas** focado em backends de alta performance (**Java**, **PHP**, **C**, **Python**) e engenharia de dados robusta (**SQL**). Especialista em **Clean Architecture** e princípios **S.O.L.I.D**.
...
Desenvolvedor de 19 anos focado na engenharia de sistemas de alta integridade. Minha atuação é pautada pelo domínio técnico profundo, transitando entre a gestão rigorosa de recursos em **C** e **Java**, backends resilientes em **PHP (Core)** e **Python**, e a criação de interfaces modernas.

*19-year-old developer focused on high-integrity systems engineering. Driven by deep technical expertise, navigating between rigorous resource management in **C** and **Java**, resilient corporate backends in **PHP (Core)** and **Python**, and modern high-performance interfaces.*
...
**Português Nativo** &nbsp;|&nbsp; **Technical English (Advanced)** &nbsp;|&nbsp; *Learning: German, Spanish, French, Italian*
